          ...
          >
            <div className="flex relative items-center justify-center  text-white text-sm font-semibold rounded-l-xl h-12 border-r-2 border-gray-200/5 bg-indigo-900">
              ...
              >
                ...
                <Listbox.Options className="flex cursor-pointer rounded-xl z-30 bg-indigo-950 absolute left-0 -bottom-48  flex-col">
                  {options.map((option) => (
                    <Listbox.Option
                      className="pl-4 py-3 first:border-none border-t-2 border-gray-200/30 pr-12 "
                      key={option.id}
                      value={option}
                    >
                      {option.name}
            ...
            <div className="relative w-full">
              <input
                ...
                className="pr-24 h-12 rounded-r-xl w-full text-sm md:text-lg font-semibold text-white  focus:bg-indigo-800 outline-none duration-150 px-3 bg-indigo-900"
              ></input>
              <button
                onClick={() => {
